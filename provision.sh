...
clone_if_missing \
"https://github.com/DonutsDelivery/ComfyUI-DonutNodes.git" \
"donutnodes"

clone_if_missing \
"https://github.com/DemonNCoding/PromptGenerator12Columns.git" \
"PromptGenerator12Columns"

clone_if_missing \
"https://github.com/artokun/comfyui-mcp-panel.git" \
"comfyui-mcp-panel"
...
clone_if_missing \
"https://github.com/BenjaMITM/Enhanced-Civicomfy.git" \
"Enhanced-Civicomfy"
...
download_model \
"https://huggingface.co/beznogim666/gonzalomo-krea-2/resolve/main/gonzalomoKrea2_v10.safetensors" \
"$COMFY/models/checkpoints/krea2.safetensors"

download_model \
"https://huggingface.co/kkangnom/FLUX.2-klein-9B-Blitz-ComfyUI/resolve/main/DarkBeast-Klein9b-V2-BFS-FP8-ComfyUI.safetensors" \
"$COMFY/models/checkpoints/flux2_klein.safetensors"

download_model \
"https://huggingface.co/Zillis/moodyPornMix/resolve/main/moodyPornMix/moodyPornMix_zitV9.safetensors" \
"$COMFY/models/checkpoints/z-image.safetensors"

download_model \
"https://huggingface.co/Phr00t/Qwen-Image-Edit-Rapid-AIO/resolve/main/v23/Qwen-Rapid-AIO-NSFW-v23.safetensors" \
"$COMFY/models/checkpoints/qwen-image.safetensors"

download_model \
"https://huggingface.co/Phr00t/WAN2.2-14B-Rapid-AllInOne/resolve/main/Mega-v12/wan2.2-rapid-mega-aio-nsfw-v12.safetensors" \
"$COMFY/models/checkpoints/wan22_i2v.safetensors"
...
download_model \
"https://huggingface.co/tripolskypetr/Qwen3VL-Uncensored-Aggressive-GGUF/resolve/main/Qwen3VL-8B-Uncensored-HauhauCS-Aggressive-Q4_K_M.gguf" \
"$COMFY/models/llm/Qwen3VL-8B-Uncensored-HauhauCS-Aggressive-Q4_K_M.gguf"

download_model \
"https://huggingface.co/tripolskypetr/Qwen3VL-Uncensored-Aggressive-GGUF/resolve/main/Qwen3VL-8B-Uncensored-HauhauCS-Balanced-mmproj-f16.gguf" \
"$COMFY/models/llm/GGUF/Qwen3VL-8B-Uncensored-HauhauCS-Balanced-mmproj-f16.gguf"
...
"$COMFY/models/clip/nsfw-umt5_xxl.safetensors"
